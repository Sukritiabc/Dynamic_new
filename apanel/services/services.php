        ...
        <div class="example-code">
            ...
            <input type="hidden" name="type" value="<?php echo $typeid; ?>"/>
                ...
                <div class="form-row">
                    ...
                    <input id="" class="custom-radio" type="radio" name="linktype" value="0" onClick="linkTypeSelect(0, '<?= $saved_src ?>');" <?php echo !empty($internal)?$internal:"checked";?>>
                    <label for="">Internal Link</label>
                    <input id="" class="custom-radio" type="radio" name="linktype" value="1" onClick="linkTypeSelect(1, '<?= $saved_src ?>');" <?php echo !empty($external)?$external:"";?>>
