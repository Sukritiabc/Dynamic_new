        ...
        <form action="" class="col-md-12 center-margin" id="location_frm">
            ...
            <div class="form-row hide">
             ...
             <div class="form-row">
                ...
                <div class="form-input col-md-20">
                    <input placeholder="Contact Info" class="col-md-6" type="text" name="contact_info2" id="contact_info2"
            ...
            <div class="form-row <?php echo ($locationRow->location_type == 0) ? 'hide' : ''; ?> google-map-link">
                <div class="form-label col-md-2">
                ...
                <div class="form-input col-md-4">
                    <textarea name="google_map" id="google_map"
                            class="large-textarea validate[required]"><?php
                        echo !empty($locationRow->google_map)
                            ? $locationRow->google_map
                            : "";
                    ?></textarea>
                </div>
            </div>
