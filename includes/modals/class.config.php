...
class Config extends DatabaseObject
{
    ...
    protected static $db_fields = array(
        'id', 'sitetitle', 'icon_upload', 'logo_upload', 'logo_upload2','fb_upload', 'twitter_upload', 'gallery_upload', 'contact_upload', 'other_upload', 'facility_upload', 'offer_upload',
        'sitename', 'location_type', 'location_map','google_map', 'location_image', 'fiscal_address', 'mail_address', 'contact_info', 'address', 'email_address', 'breif',
