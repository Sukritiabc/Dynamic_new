...
function deleteTempimage2(Re)
{
	$('#previewUserimage2'+Re).fadeOut(1000,function(){
		$('#previewUserimage2'+Re).remove(); 
		$('#preview_Image2').html('<input type="hidden" name="imageArrayname" value="" class="">');
	});
}
